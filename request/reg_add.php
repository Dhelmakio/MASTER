...
$_POST['hr_number']??null,$_POST['date_hired']??null,$_POST['e_status']??null,$_POST['m_salary']??null,strtoupper($_POST['bank']??null),strtoupper($_POST['t_card']??null), (($_POST['loan'] != "No") ? $_POST['loan'].'-'.$_POST['loan_spec']??null.'-'.$_POST['sma']??null : $_POST['loan'])??null, $_POST['ms_salary']??null,
