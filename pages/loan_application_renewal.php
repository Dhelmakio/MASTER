                                    ...
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                    ...
                                                    $sql = "select l.*,SUM(p.amount) as total_paid,(SELECT CONCAT(lastname,', ',firstname,' ',middlename,' ',suffix) as name from applicants_personal where applicants_personal.applicant_code=l.client_id) as name from loan_applications l 
