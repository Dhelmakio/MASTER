...
$sched = new Schedule($loan->contractNo);
...
$max_month;
    ...
    $newNetLoanPerMonth = (($loan->netLoanPerMonth * $max_month) - $sched->principal) / $max_month;
...
<body>
                                        ...
                                        Personal Information
                                            ...
                                            ?>
                                                    ...
                                                    <div class="col-lg-11" style="font-size:15px;"><br>
                                                        ...
                                                        <div class="col-lg-3"><label>₱
                                                                <?php echo number_format(floatval($newNetLoanPerMonth), 2); ?></label>
                                                        </div>
    ...
    $("#months").change(function() {
        ...
        // maxLoanAmount = ((<?php echo floatval($loan->monthlyNetSal) - floatval($loan->monthlyLoanAmortization) ?>) - <?php echo floatval($loan->clientSukli) ?>) * parseInt(duration);
        maxLoanAmount = <?php echo $newNetLoanPerMonth ?> * parseInt(duration);
        ...
        if(maxLoanAmount > 0){
            ...
            alert(`Cannot proceed to loan amount due to ( ${maxLoanAmount} ) value on loanable amount assessment.`);
        }
