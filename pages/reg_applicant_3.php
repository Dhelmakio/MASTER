...
if(isset($_POST['submit'])){
    ...
    $spouse_pob = strtoupper($_POST['spouse_pob']);
    $spouse_address = strtoupper($_POST['spouse_address']);
    $spouse_occupation = strtoupper($_POST['spouse_occupation']);
    // $spouse_position = strtoupper($_POST['spouse_position']);
    $spouse_employer = strtoupper($_POST['spouse_employer']);
    // $spouse_employer_contact = $_POST['spouse_employer_contact'];
    // echo "DATE OF BIRTH: ".$dob;
    if(isset($_POST['dep_name'])){
        $wdep = true;
        $dep_name = $_POST["dep_name"];
        $dep_dob = $_POST["dep_dob"];
    }
    // if(isset($_POST['rlw'])){
    //     $living = strtoupper($_POST['rlw']);
    // }
    ...
    $sql = "INSERT INTO client_info (client_id,mother_name,mother_contact,father_name,father_contact,marital_status,spouse_name,spouse_contact,spouse_dob,spouse_pob,spouse_address,spouse_occupation,spouse_employer)VALUES('$id','$mother_name','$mother_contact','$father_name','$father_contact','$marital','$spouse_name','$spouse_contact','$spouse_dob','$spouse_pob','$spouse_address','$spouse_occupation','$spouse_employer')";
    if(mysqli_query($con, $sql)){
        // $rid = mysqli_insert_id($con);
        
        // $insert_dep= "";
        // echo $countarr;
        // for($count = 0; $count <= $countarr; $count++){
        //     $insert_dep = "INSERT INTO dependents (client_id,name,dob) values('$id','$dep_name[$count]','$dep_dob[$count]')";
        //     echo $id.' '.$dep_name[$count].' '.$dep_dob[$count];
        //     mysqli_query($con,$insert_dep);
        // }
        // mysqli_multi_query($con, $sql);
        if($wdep == true){
            $countarr = count($dep_name);
            $count = 0;
            foreach($dep_name as $dname){
                $insert_dep = "INSERT INTO dependents (client_id,name,dob) values('$id','$dep_name[$count]','$dep_dob[$count]')";
                echo $id.' '.$dep_name[$count].' '.$dep_dob[$count];
                mysqli_query($con,$insert_dep);
                $count++;
        ...
        $act = "Added client information: ".$id;
        $log = "INSERT into activity_logs (user_id,name,activity) values ('$alog_id','$alog_name','$act')";
        mysqli_query($con,$log);
        header('location: reg_applicant_employment.php?id='.$id);
        // echo "New record created successfully. Last inserted ID is: " . $last_id;
    }else{
        echo "Error: " . $sql . "<br>" . $con->error;
    }
}else{
    header('location: main_client_1.php');
}
...
<html lang="en">
    <head>
        ...
        <title>Lending System - Applicants Information Registry</title>
                            ...
                            <div class="panel tabbed-panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="tab-content">
                                        ...
                                        <h3>Step 3: Family Background</h3>
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <form role="form" action="reg_applicant_employment.php" method="post">
                                                        <!-- separator -->
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <!-- <input type="text" name="father_contact" class="form-control" minlength="11" placeholder="Enter 11 digit mobile number (e.g. 09123456789)"> -->
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
