                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="col-lg-6">
                                                            <h4>Name of Borrower: &nbsp;<b><?php echo $rowApp['firstname']." ".$rowApp['middlename']." ". $rowApp['lastname']; ?></b></h4>
                                                        </div>
                                                    ...
                                                    <form role="form" action="loan_application_process.php" method="post">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group" id="loan-amnt-section" style="visibility:hidden">
                                                                ...
                                                                <input type="number" id="lamt" class="form-control" step="0.01" min="1" max="<?php echo $max_loan?>" name="loan_amt" placeholder="Loan Amount" required>
                                                        ...
                                                        <div id="calculation" class="col-lg-12" style="display:none;">
                                                            ...
                                                            <div class="col-lg-6" align="center" style="visibility:hidden;" id="submit_btn"><br>
                                                                <button onclick="" class="btn btn-primary" onclick="return confirm('Please confirm submission of Loan Application.');" name="submit">
