    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Update Borrowing History</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="row">
                                                                    ...
                                                                    $sql = "SELECT * FROM borrowing_history WHERE bh_id = '$id'";
                                                                        ...
                                                                        <form id="msform" method="POST"
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div class="form-group">
                                                                                    <label>Base</label>
                                                                                    <input type="hidden" name="id" value="<?= $row['bh_id'] ?>">
                                                                                    <input
                                                                                        class="form-control text-right"
                                                                                        name="base"
                                                                                        onkeypress="return onlyNumberKey(event)"
                                                                                        maxlength="11"
                                                                                        value="<?php echo $row['base'] ?>">
                                                                                </div>
                                                                            </div>
                                                                            <a href="setting_borrowing_history.php" id="submit_add"
                                                                                class="btn-default btn"
                                                                                style="margin-left: 10px;">
                                                                                Cancel</a>

                                                                            <button type="submit" name="submit_base"
