    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Update Processing</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="row">
                                                                    ...
                                                                    $sql = "SELECT * FROM processing WHERE processing_id = '$id'";
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div class="form-group">
                                                                                    <input type="hidden"
                                                                                        ...
                                                                                        value="<?php echo $row['processing_id'] ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="form-group">
                                                                                    <label>Processing Label</label>
                                                                                    <input disabled class="form-control"
                                                                                        value="<?php echo $row['processing_name'] ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="form-group">
                                                                                    <label>Processing Percentage</label>
                                                                                    <input
                                                                                        class="form-control text-right"
                                                                                        name="processing"
                                                                                        onkeypress="return onlyNumberKey(event)"
                                                                                        maxlength="11"
                                                                                        value="<?php echo $row['processing_percentage'] ?>">
                                                                                </div>
                                                                            </div>
                                                                            <a href="setting_processing.php"
                                                                                class="btn-default btn"
                                                                                style="margin-left: 10px;">
                                                                                Cancel</a>

                                                                            <button type="submit" name="submit_processing"
