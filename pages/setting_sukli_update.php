                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="row">
                                                                    ...
                                                                    $sql = "SELECT * FROM sukli WHERE sukli_id = '$id'";
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div class="form-group">
                                                                                    <input type="hidden"
                                                                                        ...
                                                                                        value="<?php echo $row['sukli_id'] ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="form-group">
                                                                                    <label>Sukli Label</label>
                                                                                    <input disabled class="form-control"
                                                                                        value="<?php echo $row['sukli_name'] ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="form-group">
                                                                                    <label>Sukli Amount (₱)</label>
                                                                                    <input
                                                                                        class="form-control text-right"
                                                                                        name="sukli"
                                                                                        onkeypress="return onlyNumberKey(event)"
                                                                                        maxlength="11"
                                                                                        value="<?php echo $row['sukli_amount'] ?>">
                                                                                </div>
                                                                            </div>
                                                                            <a href="setting_sukli.php" id="submit_add"
                                                                                class="btn-default btn"
                                                                                style="margin-left: 10px;">
                                                                                Cancel</a>

                                                                            <button type="submit" name="submit_sukli"
