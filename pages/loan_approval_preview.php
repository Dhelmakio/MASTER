                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                            ...
                                            <tbody>
                                                <?php
                                                    for($x = 1; $x <= $duration; $x++){
                                                        ?><tr>
                                                            <td><?php echo $x;?></td>
                                                            <td style="text-align:right;"><?php echo number_format(($interest/$duration),2);?></td>
                                                            <td style="text-align:right;">₱ <?php echo number_format($monthly,2);?></td>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <th style="text-align:right;">₱ <?php echo number_format($monthly*$duration,2);?></th>
                                                            <th></th>
                                                        </tr>
                        ...
                        <div class="col-lg-12" align="center">
                            ...
                            <button type="button" class="btn btn-danger btn-sml" data-toggle="modal" data-target="#myModal_<?php echo $cid?>">
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        <form action="loan_approval_reject.php" method="POST">
                                                                                                            <div class="col-lg-12" >
                                                                                                                    ...
                                                                                                                    <input type="text" class="form-control" name="reason" value="" placeholder="Enter reason" required>
                                                                                                                    <input type="text" name="con" value="<?php echo $contract_no;?>" hidden><br>                                                                                                                    
                                                                                                            </div>
                                                                                                            <div class="col-lg-12" align="right">
                                                                                                                    <button type="submit" class="btn btn-primary" name="submit">
                                                                                                                        Confirm <i class="fa fa-check" aria-hidden="true" title="Copy to use save"></i> 
                                                                                                                    </button>
                                                                                                            </div>
                                                                                                        </form>
                                                                                                        <div class="col-lg-6">
